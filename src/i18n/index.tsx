...
const zhCN = {
  ...
  "top.enginesReady": "COLMAP · Brush 就绪",
  "task.create": "新建任务",
  "task.running": "运行中",
  "task.idle": "待命",
  "task.console": "生成控制台",
  ...
  "project.rootHint": "原图、透明 output、遮罩与重建成果分别保存。",
  "quality.label": "生成质量",
  "quality.fast": "Plus",
  "quality.fastHint": "8,000 步",
  "quality.balanced": "Pro",
  "quality.balancedHint": "15,000 步",
  "quality.high": "精细",
  ...
  "history.emptyHint": "导入同一物体的照片，检查抠图后开始生成。成果会显示在这里。",
  "project.date": "生成日期",
  "project.elapsed": "耗时",
  "project.quality": "档位",
  ...
  "privacy.improve": "帮助改进 IA'GS",
  "privacy.title": "隐私",
  "privacy.closeAria": "关闭隐私设置",
  "privacy.intro": "分享匿名的使用与性能统计，帮助我们改善 IA'GS 的稳定性和处理体验。是否参与完全由你决定，之后也可以随时关闭。",
  ...
  "privacy.analyticsHint": "分享匿名的使用与性能数据，帮助改进 IA'GS。不会收集任何素材、文件路径或个人信息。",
  ...
  "viewer.invalidBounds": "PLY 已加载，但无法读取有效的模型边界。请确认该文件是 IA'GS 生成的 Brush Gaussian PLY。",
  ...
  "viewer.watermarkLoad": "无法加载 IA'GS 水印 Logo。",
...
const en: Record<TranslationKey, string> = {
  ...
  "language.switchTo": "中英文切换 / Switch language", "language.target": "中文", "top.settings": "Settings", "top.checkingEngines": "Checking bundled engines", "top.engineIssues": "{count} engine issues", "top.enginesReady": "COLMAP · Brush ready",
  "task.create": "New task", "task.running": "Running", "task.idle": "Standby", "task.console": "Generation console",
  ...
  "project.root": "Save location", "project.readingRoot": "Reading default folder", "project.rootHint": "Each generation creates a separate project folder here, with final.ply saved at its root.",
  "quality.label": "Generation quality", "quality.fast": "Plus", "quality.fastHint": "8,000 steps", "quality.balanced": "Pro", "quality.balancedHint": "15,000 steps", "quality.high": "Detailed", "quality.highHint": "Use more of the source image detail",
  ...
  "sequence.title": "Large image sequence", "sequence.hint": "More than 500 images can require much more time and disk space for exhaustive matching. IA'GS will ask again before generation starts.",
  ...
  "history.title": "02 Task History", "history.aria": "Project results", "history.refresh": "Refresh", "history.completed": "Completed", "history.unfinished": "Unfinished", "history.projects": "{count} projects", "history.emptyTitle": "No projects yet", "history.emptyHint": "Import photos of one object, review the masks, then generate. Results will appear here.",
  "project.date": "Created", "project.elapsed": "Elapsed", "project.quality": "Preset", "project.opening": "Opening", "project.preview": "Preview", "project.resume": "Resume task", "project.reveal": "Show in Finder", "project.delete": "Delete",
...
const STORAGE_KEY = "iags-language";
...
export function localizePipelineMessage(locale: Locale, message: string): string {
  ...
  const patterns: Array<[RegExp, (...values: string[]) => string]> = [
    ...
    [/^Brush 训练 ([\d.]+)%( · 已用时 (.+))?$/, (percent, _suffix, elapsed) => `Brush training ${percent}%${elapsed ? ` · Elapsed ${elapsed}` : ""}`],
    [/^Brush 训练 100% · 正在导出模型 · 已用时 (.+)$/, (elapsed) => `Brush training 100% · Exporting model · Elapsed ${elapsed}`],
    [/^Brush 正在初始化 · 已用时 (.+)$/, (elapsed) => `Brush initializing · Elapsed ${elapsed}`],
